...
//#define POSTFUNCTION_FOR_KEYBOARD_INPUT PostTeam13BotHSM
...
typedef enum {
    ...
    BACK_WIRE_HIGH,
    BACK_WIRE_LOW,
    CLOSE_FRONT_WIRE_HIGH,
    CLOSE_FRONT_WIRE_LOW,
    CLOSE_BACK_WIRE_HIGH,
    CLOSE_BACK_WIRE_LOW,
    BEACON_LOST,
    BEACON_FOUND,
    FL_BUMPER_UP,
...
#define EVENT_CHECK_LIST  CheckFrontTrackWire, CheckBackTrackWire, CheckBeacon, CheckBumpers, CheckTapeSensors, CheckCloseFrontTrackWire, CheckCloseBackTrackWire,CheckSideTapeSensors
...
#define TIMER0_RESP_FUNC  PostTeam13BotHSM
#define TIMER1_RESP_FUNC PostTeam13BotHSM
...
#define TOP_LEVEL_TIMER 0 /*make sure this is enabled above and posting to the correct state machine*/
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "Team13BotHSM.h"
// the name of the Init function
#define SERV_1_INIT InitTeam13BotHSM
// the name of the run function
#define SERV_1_RUN RunTeam13BotHSM
